...
Indicates parsing position and remaining text to be parsed.
...
A `++path` is a list of [`++span`]() aka [`@ta`](). Used in
...
lowercase ASCII and `-`, `0-9`, both of which can neither be the first of last
